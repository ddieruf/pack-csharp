...
namespace pack_csharp.Runner
{
  public static class ArgumentEscaper
  {
    ...
    private static IEnumerable<string> EscapeArgArray(IEnumerable<string> args)
    {
      ...
      foreach (var arg in args) escapedArgs.Add(EscapeSingleArg(arg));
    ...
    private static IEnumerable<string> EscapeArgArrayForCmd(IEnumerable<string> arguments)
    {
      ...
      foreach (var arg in arguments) escapedArgs.Add(EscapeArgForCmd(arg));
    ...
    internal static bool ShouldSurroundWithQuotes(string argument)
    {
      ...
      if (IsSurroundedWithQuotes(argument)) return false;
    ...
    {
      return argument.StartsWith("\"", StringComparison.Ordinal) && argument.EndsWith("\"", StringComparison.Ordinal);
    }
